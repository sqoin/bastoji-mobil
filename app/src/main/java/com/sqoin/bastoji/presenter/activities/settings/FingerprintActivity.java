...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), CurrencyUtils.getFormattedAmount(this, "BTJ", amount), CurrencyUtils.getFormattedAmount(this, iso, curAmount));
    }
